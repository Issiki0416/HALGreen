                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <textarea id="information" name="information" rows="8" required
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="current_quantity" class="outline-none text-gray-700 py-1 px-3 leading-8">現在の在庫数</label>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div><input type="radio" name="type"
                                            value="{{ \Constant::PRODUCT_LIST['add'] }}" class="mr-2" checked>在庫追加</div>
                                    <div><input type="radio" name="type"
                                            value="{{\Constant::PRODUCT_LIST['reduce'] }}" class="mr-2">在庫削減</div>
                                </div>
                            </div>
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
